...
extension CocoaDebugViewController: BubbleDelegate {
    ...
    func didTapBubble() {
        ...
        let storyboard = UIStoryboard(name: "Manager", bundle: CocoaDebugBundle.resource)
        let vc = storyboard.instantiateInitialViewController() ?? CocoaDebugTabBarController()
